  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 max-w-3xl mx-auto">
      <div className="flex items-center gap-3 mb-6 border-b pb-4">
        ...
        <h2 className="text-xl font-bold text-[#001f3f]">Gestión de Talento</h2>
      </div>
      ...
      <form onSubmit={handleSave} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2">
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#001f3f] focus:border-[#001f3f] outline-none transition-shadow"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              className="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#001f3f] focus:border-[#001f3f] outline-none transition-shadow bg-white"
            >
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              rows="3"
              maxLength="300"
              className="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#001f3f] focus:border-[#001f3f] outline-none transition-shadow resize-none"
            ></textarea>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#001f3f] focus:border-[#001f3f] outline-none transition-shadow file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-medium file:bg-pink-50 file:text-pink-600 hover:file:bg-pink-100"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#001f3f] focus:border-[#001f3f] outline-none transition-shadow file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-medium file:bg-[#001f3f] file:text-white hover:file:bg-blue-900"
            />
          </div>
        ...
        <div className="pt-4 border-t border-gray-100 flex justify-end">
          <button
            type="submit"
            disabled={saving}
            className="flex items-center justify-center gap-2 px-8 py-3 bg-[#001f3f] hover:bg-blue-900 text-white font-semibold rounded-xl transition-all shadow-md disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {saving ? (
              <>
      ...
      <div className="mt-12">
        <div className="flex items-center gap-3 mb-6 border-b pb-4">
          <Users className="w-6 h-6 text-[#001f3f]" />
          <h2 className="text-xl font-bold text-[#001f3f]">Candidatas Registradas</h2>
        </div>
